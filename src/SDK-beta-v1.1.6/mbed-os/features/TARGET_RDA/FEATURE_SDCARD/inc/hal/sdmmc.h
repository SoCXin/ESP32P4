...
void rda_sdmmc_read_blocks(UINT8 *buffer, UINT32 block_start, UINT32 block_num);
void rda_sdmmc_write_blocks(CONST UINT8 *buffer, UINT32 block_start, UINT32 block_num);
